...
//console.log(obtenerMayor(11,10))
...
// console.log(fizzBuzz(7));   // Output: false
...
// console.log(operadoresLogicos(55, 2, 10))
// console.log(operadoresLogicos(-3, 7, 45))
// console.log(operadoresLogicos(4, 6, 10))
// console.log(operadoresLogicos(0, 0, 0))
// console.log(operadoresLogicos("6", "f", "f"))
